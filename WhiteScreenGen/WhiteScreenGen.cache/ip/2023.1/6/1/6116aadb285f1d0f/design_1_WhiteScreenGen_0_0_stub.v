...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(pxlClk, clk, R, G, B, Vsync_out, Hsync_out)
/* synthesis syn_black_box black_box_pad_pin="pxlClk,clk,R,G,B,Vsync_out,Hsync_out" */;
  input pxlClk;
  input clk;
  output R;
  output G;
