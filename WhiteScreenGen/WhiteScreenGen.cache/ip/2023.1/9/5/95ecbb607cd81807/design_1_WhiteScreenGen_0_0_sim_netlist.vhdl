...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_WhiteScreenGen is
  ...
  signal R_reg_i_3_n_1 : STD_LOGIC;
  signal R_reg_i_3_n_2 : STD_LOGIC;
  signal R_reg_i_3_n_3 : STD_LOGIC;
  ...
  signal Vsync_out16_out : STD_LOGIC;
  ...
  signal NLW_R_reg_i_3_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of R_i_4 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of R_i_5 : label is "soft_lutpair0";
  ...
  attribute COMPARATOR_THRESHOLD of R_reg_i_3 : label is 11;
  ...
  attribute SOFT_HLUTNM of \pxlclkcounter[31]_i_7\ : label is "soft_lutpair1";
...
R_reg_i_3: unisim.vcomponents.CARRY4
     port map (
      CI => R_reg_i_7_n_0,
      CO(3) => Vsync_out21_in,
      CO(2) => R_reg_i_3_n_1,
      ...
      DI(2 downto 0) => B"000",
      O(3 downto 0) => NLW_R_reg_i_3_O_UNCONNECTED(3 downto 0),
      S(3) => R_i_8_n_0,
      S(2) => R_i_9_n_0,
      S(1) => R_i_10_n_0,
      S(0) => R_i_11_n_0
