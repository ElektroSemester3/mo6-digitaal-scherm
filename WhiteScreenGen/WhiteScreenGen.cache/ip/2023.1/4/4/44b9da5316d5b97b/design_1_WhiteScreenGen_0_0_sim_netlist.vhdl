...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_WhiteScreenGen is
  ...
  signal \Hcounter[31]_i_10_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_11_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_12_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_13_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_14_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_15_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_1_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_2_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_3_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_4_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_5_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_6_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_7_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_8_n_0\ : STD_LOGIC;
  signal \Hcounter[31]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \vcounter[31]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_15\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_18\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \Hcounter[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Hcounter[31]_i_10\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Hcounter[31]_i_12\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Hcounter[31]_i_13\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Hcounter[31]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Hcounter[31]_i_9\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of Vsync_out_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \vcounter[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \vcounter[31]_i_10\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \vcounter[31]_i_6\ : label is "soft_lutpair2";
...
\Hcounter[31]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Hcounter[31]_i_11\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Hcounter[31]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Hcounter[31]_i_13\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Hcounter[31]_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Hcounter[31]_i_15\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Hcounter[31]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\Hcounter[31]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\Hcounter[31]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Hcounter[31]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\Hcounter[31]_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\Hcounter[31]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
Hsync_out_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
Hsync_out_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
R_i_10: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\vcounter[31]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
...
\vcounter[31]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
