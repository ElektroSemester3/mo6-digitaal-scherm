...
compile()
{
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../ShiftRegTest.gen/sources_1/bd/design_1/ipshared/30ef" +incdir+"../../../../ShiftRegTest.gen/sources_1/bd/design_1/ipshared/30ef" \
